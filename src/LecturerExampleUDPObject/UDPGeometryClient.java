	...
	private void displayFrame() {
		...
		jbtMidPoint.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Points p1 = new Points(Double.parseDouble(
					jtfPointOneX.getText()), Double.parseDouble(jtfPointOneY.getText()));
				Points p2 = new Points(Double.parseDouble(
				...
				try {
					...
					Points midPoint = (Points)is.readObject();
	...
	public static void main(String args[]) {
		if(args.length == 0) {
			/*
				...
				args[1] => port
			*/
			new UDPGeometryClient("localhost", 8000);
		}
		else {
